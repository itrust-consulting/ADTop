...
public class Measure {
	...
	@JsonCreator
	public Measure(@JsonProperty("cost")double cost, @JsonProperty("effectiveness")double effectiveness, @JsonProperty("name")String name,@JsonProperty("implRate") double implRate, @JsonProperty("id")Long id) {
		this.cost = cost;
	...
	@JsonCreator
	public Measure(@JsonProperty("effectiveness")double effectiveness,@JsonProperty("id")Long id){
		this.effectiveness = effectiveness;
		this.id = id;
	}
